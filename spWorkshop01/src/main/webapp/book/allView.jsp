...
<select name="command" id="command" >
	...
	<option value="findByTitle">제목으로 검색하기</option>
	<option value="findByIsbn">isbn으로 검색하기</option>
	<option value="findByAuthor">저자로 검색하기</option>
</select>
...
<table border="1" width="850" bgcolor="white" align="center">
	...
	<h6 align="center"> <a href="Book.html" >도서등록</a></h6>
